...
use App\Http\Controllers\Api\V1\PayrollDraftController;
...
use App\Http\Controllers\Api\V1\QuarterTypeController;
...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware(['auth:sanctum', 'hrms.session', 'cirt.company'])->group(function () {
        ...
        Route::middleware('managerial')->group(function () {
            ...
            Route::get('settings/quarter-types', [QuarterTypeController::class, 'index']);
            Route::post('settings/quarter-types', [QuarterTypeController::class, 'store']);
            Route::put('settings/quarter-types/{id}', [QuarterTypeController::class, 'update']);
            Route::post('settings/quarter-types/{id}/deactivate', [QuarterTypeController::class, 'deactivate']);
            Route::post('settings/quarter-types/{id}/activate', [QuarterTypeController::class, 'activate']);
