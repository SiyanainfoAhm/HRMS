...
export function resolveConvertPayrollMasterInput(
  ...
  const dedRow: Record<string, unknown> = {
    ...
    loan_recovery_default: Math.max(0, Math.round(pickNum(o, ["loan_recovery_default", "loanRecoveryDefault", "horticulture_default", "horticultureDefault"], 0))),
...
export function payrollMasterPayloadForClient(r: ResolvedConvertPayroll) {
  ...
  return {
    ...
    loan_recovery_default: Number(d.loan_recovery_default ?? d.horticulture_default) || 0,
