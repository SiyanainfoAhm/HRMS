...
export async function GET(request: NextRequest) {
    ...
    .map((log: any) => {
      ...
      const lunchMinEffective =
        grossMin != null
          ...
          : recordedLunchMin;
      const activeMin =
        grossMin != null ? Math.max(0, grossMin - lunchMinEffective - teaMin) : null;
      return {
        logId: log.id,
        ...
        mandatoryLunchAssumed:
          grossMin != null && lunchMinEffective > recordedLunchMin,
  ...
  rows.sort((a: any, b: any) => {
    ...
    return String(a.employeeName || a.employeeEmail).localeCompare(String(b.employeeName || b.employeeEmail));
  });
