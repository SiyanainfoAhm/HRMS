...
export async function GET() {
  ...
  if ((data ?? []).length === 0) {
    const { data: seededTypes, error: seedErr } = await supabase
      ...
      .upsert(
      [
        { company_id: me.company_id, name: "Paid Leave", code: "PAID", is_paid: true },
        { company_id: me.company_id, name: "Sick Leave", code: "SICK", is_paid: true },
        { company_id: me.company_id, name: "Unpaid Leave", code: "UNPAID", is_paid: false },
      ],
