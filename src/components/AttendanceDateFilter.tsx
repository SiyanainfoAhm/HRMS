  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      {customOpen && (
        ...
        >
          <p className="mb-3 text-sm font-medium text-slate-800">Pick a range or a single day (second click completes the range)</p>
          ...
          <div className="mt-4 flex flex-wrap items-center justify-end gap-2 border-t border-slate-100 pt-3">
            ...
            <button type="button" className="btn btn-primary rounded-lg px-4 py-1.5 text-sm" onClick={() => applyCustom()}>
              Apply
            </button>
          </div>
        </div>
