...
export function Topbar({
  ...
  return (
    <header className="hidden shrink-0 border-b border-brand-border bg-white/90 backdrop-blur-md md:flex md:h-14 md:items-center md:justify-between md:px-5 lg:px-6">
