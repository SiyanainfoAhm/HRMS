-- Reimbursements: payroll month targeting, approver user, inclusion in payroll run
...
alter table if exists "HRMS_reimbursements" alter column payroll_year set not null;
alter table if exists "HRMS_reimbursements" alter column payroll_month set not null;
